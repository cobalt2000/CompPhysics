...
//    int info;    // This is a flag used to tell if the function worked correctly.
    ...
    double Yteff=ytsm*2; // Effective top coupling in the new model
    double Ybeff=ybsm*2; // Effective bottom coupling in the new model
    ...
    // Call solver
    xsgaga=h2gaga( higgsmass, Yteff, Ybeff );
